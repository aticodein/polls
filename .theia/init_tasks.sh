...
echo 'alias col=python3 manage.py collectstatic' >> ~/.bashrc
echo 'alias mak=python3 manage.py makemigrations' >> ~/.bashrc
echo 'alias mig=python3 manage.py migrate' >> ~/.bashrc
echo "Done"
source ~/.bashrc
